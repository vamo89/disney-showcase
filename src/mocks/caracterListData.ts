...
// https://api.disneyapi.dev/character at 2025-01-02
const mockCharacterListResponse = {
  info: {
    count: 50,
    totalPages: 149,
    previousPage: null,
...
// Helper to get just the character data - we are not using pagination yet
export const mockCharacterList = mockCharacterListResponse.data as Character[];
